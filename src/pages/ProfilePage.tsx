                          ...
                          >
                            <div className="flex items-center justify-between border-b border-[#C8B89A]/30 pb-2.5">
                              ...
                              <button
                                ...
                                className={`text-xs font-bold flex items-center gap-1 min-h-[36px] px-2.5 py-1 rounded-lg transition-colors ${passport.people.length <= 2
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs font-semibold min-h-[44px] ${nameErr
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs min-h-[44px] ${emailErr
                                      ? 'border-red-500 bg-red-50/30 ring-2 ring-red-400'
                                      : 'border-[#C8B89A] bg-white'
                                    }`}
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs min-h-[44px] ${mobileErr
                              ...
                              <div>
                                ...
                                <select
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs min-h-[44px] ${yearErr
                                      ? 'border-red-500 bg-red-50/30 ring-1 ring-red-400'
                                      : 'border-[#C8B89A] bg-white'
                                    }`}
                                >
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs min-h-[44px] ${instErr
                                      ? 'border-red-500 bg-red-50/30 ring-1 ring-red-400'
                                      : 'border-[#C8B89A] bg-white'
                                    }`}
                                />
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-2.5 rounded-lg border text-sm sm:text-xs min-h-[44px] ${deptErr
                                      ? 'border-red-500 bg-red-50/30 ring-1 ring-red-400'
                                      : 'border-[#C8B89A] bg-white'
                                    }`}
                                />
